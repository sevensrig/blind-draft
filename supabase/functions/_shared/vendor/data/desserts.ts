...
// Source: src/lib/data/desserts.ts. Run `npm run vendor` after changing the engine or pools.

import type { ItemSeed } from './types.ts';

export const DESSERTS: ItemSeed[] = [
	// great
	{ name: 'Cheesecake', tier: 'great' },
	{ name: 'Tiramisu', tier: 'great' },
	{ name: 'Crumbl cookies', tier: 'great' },
	{ name: 'Molten lava cake', tier: 'great' },
	{ name: 'Cinnamon rolls', tier: 'great' },
	{ name: 'Churros', tier: 'great' },
	...
	{ name: 'Frozen yogurt', tier: 'mid' },
	{ name: "S'mores", tier: 'mid' },
	{ name: 'Rice Krispie treats', tier: 'mid' },
	{ name: 'Lemon bars', tier: 'mid' },
